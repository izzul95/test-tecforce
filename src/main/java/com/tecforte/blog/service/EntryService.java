...
public class EntryService {
    ...
    /**
     * delete all Blog entries by keyword.
     *
     * @param Keyword the keyword need to delete all Blog entries.
     */

    public void deleteByKeyword(String keyword) {
        log.debug("Request to delete Blog(s) with keyword : {}", keyword);
        entryRepository.deleteAllByTitleContaining(keyword);
    }

        /**
     * delete entries in one blog by keyword.
     *
     * @param Id the Blog id.
     * @param Keyword the keyword need to delete entries.
     */

    public void deleteByKeywordWithId(Long id , String keyword) {
        log.debug("Request to delete entries in one blog {} by keyword {}", id ,keyword);
        entryRepository.deleteAllByBlogIdAndTitleContaining(id , keyword);
    }
}
